...
<body id="reservation-formbody">
    ...
    <?php
     ...
     <section  id="reservation-form-section">
     	<h1 id="h1reservation-form">Veuillez remplir le formulaire pour la réservation</h1>
     	<form class="reserv-form" method ="post" action ="">
            ...
            <input class="input-reservation-form" type="datetime-local" name="datefin" required>
            <!-- <input id="bouton-reservation-form" type="submit" value="RESERVER" name="valider"> -->
            <br><input id="bouton-reservation-form" type="image" name="valider" src="img/pistolet.png" />
     	</form>
     	<?php
